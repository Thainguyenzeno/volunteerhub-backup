  ...
  return (
      <footer className="mt-10 py-6 font-qs px-4 divide-y bg-gray-700 text-white">
        ...
        <div className="lg:w-1/3">
          <Link
            to="/"
            className="flex justify-center space-x-3 lg:justify-start cursor-pointer inter gap-1 items-center"
          >
            <img
        ...
        <div className="grid grid-cols-2 text-sm gap-x-3 gap-y-8 lg:w-2/3 sm:grid-cols-4">
          ...
          <div className="space-y-3">
            ...
            <ul className="space-y-1">
              <li><a href="#" rel="noopener noreferrer">Features</a></li>
          ...
          <div className="space-y-3">
            ...
            <div className="flex justify-start space-x-3">
              ...
              <a
                href="https://twitter.com/nahidbinwadood"
                target="_blank"
                rel="noopener noreferrer"
                title="Twitter"
                className="flex items-center p-1"
